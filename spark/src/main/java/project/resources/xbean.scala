...
package object xbean {
    ...
    case class CategoryCountInfo(taskid:String, category_id: String, clickCount:Long, orderCount:Long, payCount:Long)

    case class KafkaMessage(timestamp:String, area:String, city:String, userid:String, adid:String)
}
